...
include("./types_(StationaryPolicy_ChanceConstraint_UpperBound).jl")
include("./functions_(StationaryPolicy_ChanceConstraint_UpperBound).jl")
include("./solvers_(StationaryPolicy_ChanceConstraint_UpperBound).jl")
...
file_record = open("./result/record_(StationaryPolicy_ChanceConstraint_UpperBound).txt" , "w")
file_summary = open("./result/summary_(StationaryPolicy_ChanceConstraint_UpperBound).txt" , "w")
...
println(file_summary, " ")
println(file_summary, "Server speed optimal solution (using linear upper bound)")
for j in 1:10
...
plt.savefig("./result/server_speed_(StationaryPolicy_ChanceConstraint_UpperBound).pdf")
#plt.close()
...
plt.savefig("./result/server_queue_length_(StationaryPolicy_ChanceConstraint_UpperBound).pdf")
#plt.close()
...
plt.savefig("./result/server_price_(StationaryPolicy_ChanceConstraint_UpperBound).pdf")
...
plt.savefig("./result/server_cumulative_power_consumption_(StationaryPolicy_ChanceConstraint_UpperBound).pdf")
...
plt.savefig("./result/total_cumulative_power_consumption_(StationaryPolicy_ChanceConstraint_UpperBound).pdf")
