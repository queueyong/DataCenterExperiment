...
include("./fixed_types.jl")
include("./fixed_functions.jl")
...
file_record = open("./result/fixed_record.txt" , "w")
file_summary = open("./result/fixed_summary.txt" , "w")
...
println(file_summary, "Server speed")
for j = 1:10
  println(file_summary, "Server $j: $(speed[j])")
end
