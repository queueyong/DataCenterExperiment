...
include("./functions_(StationaryPolicy_StabilityCondition).jl")
include("./solvers_(StationaryPolicy_StabilityCondition).jl")
...
file_record = open("./result/record_(StationaryPolicy_StabilityCondition).txt" , "w")
file_summary = open("./result/summary_(StationaryPolicy_StabilityCondition).txt" , "w")
...
println(file_summary, " ")
println(file_summary, "Server speed optimal solution (using only stability condition)")
for j in 1:10
...
plt.savefig("./result/server_speed_(StationaryPolicy_StabilityCondition).pdf")
#plt.close()
...
plt.savefig("./result/server_queue_length_(StationaryPolicy_StabilityCondition).pdf")
#plt.close()
...
plt.savefig("./result/server_price_(StationaryPolicy_StabilityCondition).pdf")
...
plt.savefig("./result/server_cumulative_power_consumption_(StationaryPolicy_StabilityCondition).pdf")
...
plt.savefig("./result/total_cumulative_power_consumption_(StationaryPolicy_StabilityCondition).pdf")
