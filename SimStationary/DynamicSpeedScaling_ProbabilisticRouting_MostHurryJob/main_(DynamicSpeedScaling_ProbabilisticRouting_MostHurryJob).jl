...
include("./types_(DynamicSpeedScaling_ProbabilisticRouting_MostHurryJob).jl")
include("./functions_(DynamicSpeedScaling_ProbabilisticRouting_MostHurryJob).jl")
include("../../job_generators.jl")
include("./solvers_(DynamicSpeedScaling_ProbabilisticRouting_MostHurryJob).jl")
using PyPlot
...
file_record = open("./result/record_(DynamicSpeedScaling_ProbabilisticRouting_MostHurryJob).txt" , "w")
file_summary = open("./result/summary_(DynamicSpeedScaling_ProbabilisticRouting_MostHurryJob).txt" , "w")
...
plt.savefig("./result/server_speed_(DynamicSpeedScaling_ProbabilisticRouting_MostHurryJob).pdf")
#plt.close()
...
plt.savefig("./result/server_queue_length_(DynamicSpeedScaling_ProbabilisticRouting_MostHurryJob).pdf")
#plt.close()
...
plt.savefig("./result/server_price_(DynamicSpeedScaling_ProbabilisticRouting_MostHurryJob).pdf")
...
plt.savefig("./result/server_cumulative_power_consumption_(DynamicSpeedScaling_ProbabilisticRouting_MostHurryJob).pdf")
...
plt.savefig("./result/total_cumulative_power_consumption_(DynamicSpeedScaling_ProbabilisticRouting_MostHurryJob).pdf")
